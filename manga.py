...
def adult_gate_kb() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup([
        [
            InlineKeyboardButton("✅ Yes, I'm 18+",  callback_data="mg_adult_confirm"),
            InlineKeyboardButton("❌ No, return Me",      callback_data="mg_adult_deny"),
        ],
    ])
...
def manga_action_kb(source: str, mid: str, in_list: bool) -> InlineKeyboardMarkup:
